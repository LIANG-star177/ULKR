...
from gnn_utils import init_knowledge_base, LocalDocQA, gnn_fusion, GGATModel, graph_data, compute_case_metric
import json
import pandas as pd
...
# 微调后参数存放位置
SAVE_PATH = '/home/u12321044/share/liang_52/self-correct-retriever/rebuttal/UniLR/simcse_sup_random_large.pt'
EMBEDDING_PATH = '/home/u12321044/share/liang_52/self-correct-retriever/rebuttal/UniLR/saved_model/'
