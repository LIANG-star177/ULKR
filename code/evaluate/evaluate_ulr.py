...
# evaluate_art("/data/apps/lacode/self-correct-retriever/ulr_result/ulr_text-davinci-003_ljp.txt")
# evaluate_char("/data/apps/lacode/self-correct-retriever/ulr_result/ulr_text-davinci-003_ljp.txt")
...
evaluate_opinion("/data/apps/lacode/self-correct-retriever/ulr_result/ulr_chatglm_Consult.txt")
