...
evaluate_art("/root/data1/liang/self-correct-retriever/test_result/generation_ljp.txt")
evaluate_char("/root/data1/liang/self-correct-retriever/test_result/generation_ljp.txt")
# evaluate_pen("/root/data1/liang/self-correct-retriever/test_result/generation_ljp.txt")

#CVG
# evaluate_art_in_opinion("/root/data1/liang/self-correct-retriever/test_result/self_corr_generation_cvg.txt")
# evaluate_char_in_opinion("/root/data1/liang/self-correct-retriever/test_result/self_corr_generation_cvg.txt")
# evaluate_pen_in_opinion("/root/data1/liang/self-correct-retriever/test_result/self_corr_generation_cvg.txt")
# evaluate_opinion("/root/data1/liang/self-correct-retriever/test_result/self_corr_generation_cvg.txt")

#法条背诵
# compute_ftcs("/root/data1/liang/self-correct-retriever/test_result/self_corr_llm_generation_Article Recitation.txt")

#法考问题
# compute_jec_kd("/root/data1/liang/self-correct-retriever/test_result/self_corr_generation_Question Answering.txt")

#法律问答
compute_ftcs("/root/data1/liang/self-correct-retriever/test_result/_chatglm_generation_Consult.txt")