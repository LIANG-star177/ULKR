...
class LangChainCFG:
    ...
    vector_store_path = '/data/apps/lacode/self-correct-retriever/data/legal_articles'
    kg_vector_stores = {
        '法律法条': '/data/apps/lacode/self-correct-retriever/data/legal_articles',
...
test_path = "/data/apps/lacode/self-correct-retriever/data/exercise_contest/data_test.json"
results=[] 
...
with open("/data/apps/lacode/self-correct-retriever/result/generation.txt", "w") as f:
    for dic in results:
