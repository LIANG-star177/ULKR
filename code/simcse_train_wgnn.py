...
USE_MY = True
# 预训练模型目录
BERT = '/root/data1/liang/self-correct-retriever/checkpoint/m3e-base'
model_path = BERT

# 微调后参数存放位置
SAVE_PATH = '/root/data1/liang/self-correct-retriever/saved_model'
EMBEDDING_PATH = '/root/data1/liang/self-correct-retriever/saved_model/simcse_consult/'

# 数据位置
SNIL_TRAIN = "/root/data1/liang/self-correct-retriever/data/knowledge_base/simcse_train_consult.json"
STS_DEV = "/root/data1/liang/self-correct-retriever/data/knowledge_base/simcse_test_consult.json"
# STS_TEST = 'data/processed_random_large/test.txt'
STS_TEST = "/root/data1/liang/self-correct-retriever/data/knowledge_base/simcse_test_consult.json"

filepath="/root/data1/liang/self-correct-retriever/data/hera_knowbase3/法律咨询"
...
def initialize_process(rank, world_size, master_addr, master_port):
    ...
    # test(model, graph, top_k=3, best_path="/root/data1/liang/self-correct-retriever/saved_model/simcse_cvg_50.pt", device = DEVICE)
