...
class LangChainCFG:
    ...
    embedding_model_name = '/data/apps/lacode/wisdomInterrogatory-main/model/m3e-base'  # 检索模型文件 or huggingface远程仓库
    vector_store_path = '/data/apps/lacode/self-correct-retriever/data/cache/combine_base'
    kg_vector_stores = {
        '法律法条': '/data/apps/lacode/self-correct-retriever/data/articles_base',
        ...
        # '法律案例': '/data/apps/lacode/self-correct-retriever/data/cache/legal_cases',
        # '法律考试': '/data/apps/lacode/self-correct-retriever/data/exams_base',
...
if len(config.kg_vector_stores)>=1:
    target_folder = "/data/apps/lacode/self-correct-retriever/data/cache/combine_base"
