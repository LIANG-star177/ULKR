...
def key_words_match_intention(input):
    kg_names = set()
    with open("/data/apps/lacode/wisdomInterrogatory-main/data/cache/intention_reg.json", "r") as f:
        dic = json.load(f)
...
def init_all_articles():
    art_dir = "/data/apps/lacode/wisdomInterrogatory-main/data/cache/legal_articles"
    dic_all = {}
    choices = []
