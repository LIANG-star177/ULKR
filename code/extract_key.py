...
class testCFG:
    ...
    test_path = "/data/apps/lacode/self-correct-retriever/data/hera_knowbase/法条/刑法"
...
def test(config):
    ...
    if "法条" in config.test_path:  
        output_directory = "/data/apps/lacode/self-correct-retriever/data/hera_knowbase/法条/新刑法"
        ...
        with open(config.test_path,"r") as f: 
            ...
            for line in tqdm(lines[:1000]):
                ...
                i+=1
        write_path = "/data/apps/lacode/self-correct-retriever/data/knowledge_base/cases.json"
