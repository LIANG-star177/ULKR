...
class testCFG:
    ...
    test_path = "/root/data1/liang/self-correct-retriever/data/knowledge_base/train_consult.json"
...
def test(config):
    with open(config.test_path,"r") as f: 
        ...
        for line in tqdm(lines):
            ...
            i+=1
        write_path = "/root/data1/liang/self-correct-retriever/data/knowledge_base/train_key_consult.json.json"
