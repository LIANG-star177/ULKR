...
class testCFG:
    ...
    test_path = "/data/apps/lacode/self-correct-retriever/data/knowledge_base/balanced_train_cvg.json"
...
def test(config):
    with open(config.test_path,"r") as f: 
        ...
        for line in tqdm(lines):
            ...
            i+=1
        write_path = "/data/apps/lacode/self-correct-retriever/data/knowledge_base/balanced_key_train_cvg.json"
